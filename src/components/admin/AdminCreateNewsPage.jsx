...
export default function AdminCreateNewsPage({
  ...
  const currentPageName = "Create New Publication";
  ...
  return;
    ...
    if (publicationName  === "" || publicationContent === "") {
      setErrorMessage({
        message: "Create Publication Failed: Please enter valid details",
      });
      openNotificationModal(
        false,
        "Create Publication",
        "Create Publication Failed: Please enter valid details."
      );
    ...
    try {
      ...
      formData.append("publication_content", publicationContent);
...
openNotificationModal(
        ...
        openNotificationModal(false, "Create Publication Error", "Create Publication Failed");
      }
    } catch (error) {
      setIsCreateLoading(false);
      alert(error);
      if (
        ...
        setErrorMessage({ message: errorMessage });
        openNotificationModal(false, "Create Publication Error", errorMessage);
      } else if (
        error.response &&
        error.response.data &&
        ...
        setErrorMessage({
          message: "Create Publication failed. Please check your credentials and try again.",
        });
        openNotificationModal(
          false,
          "Create Publication Error",
          "Create Publication failed. Please check your credentials and try again."
        );
      }
    }
  };
...
<div className="flex w-full items-center justify-between  ">
                          ...
                          <div className=" text-sm">
                            Create awesome content for your ambassadors
                          </div>
                          </div>
